  ...
  mb_text2.setAttribute("id",`${d}`);
        ...
        function big(){
          if(up_tate<5){
            up_tate+=1;
            if(youso!=null){
              var ration=rererario*up_tate;
              youso.innerHTML=`<a-image id="Jirachi" scale="${ration} ${up_tate} " src="${url}"></a-image>`;
            }
          }
        }
        function small(){
        ...
        $('#upfile').change(function(e){
          ...
          reader.onload = function() {
              ...
              document.querySelectorAll('[mb-text2]').forEach(mb_text2=>{
                  ...
                  rererario=width/height;
                  mb_text2.innerHTML=`<a-image id="Jirachi" scale="${ratio} 1 " src="${reader.result}"></a-image>`
                  document.getElementById("bigbtn").removeAttribute("disabled");
                  document.getElementById("smallbtn").removeAttribute("disabled");
